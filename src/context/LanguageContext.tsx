...
const translations: Translations = {
  en: {
    ...
    aboutText: "We strive to create websites that last, inspire, and deliver results, tailored exactly to our clients' wishes. We haven't been in the game for long, but we know time is on our side, because Core delivers timeless design.",
    ...
    rightsReserved: '© 2026 Core. All rights reserved.',
  },
  bs: {
    // Navbar
    home: 'Početna',
    ...
    aboutText: 'Radimo na tome da pravimo websajtove koji traju, koji inspirišu, koji daju rezultat i to tačno po željama klijenata. Nismo dugo u igri, ali znamo da je vrijeme na našoj strani, jer Core daje dizajn van vremena.',
    ...
    rightsReserved: '© 2026 Core. Sva prava zadržana.',
  }
};
