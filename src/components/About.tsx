        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-start mb-20">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-muted leading-relaxed">
              {language === 'bs' ? (
                "Nismo dugo u igri, ali znamo da je vrijeme na našoj strani, jer Core daje dizajn van vremena. Svaki projekat je priča za sebe, a mi smo tu da je ispričamo na najbolji mogući način, kombinujući najnovije web tehnologije sa besprijekornom estetikom."
              ) : (
                "We haven't been in the game for long, but we know time is on our side, because Core delivers timeless design. Every project is a story in itself, and we are here to tell it in the best possible way, combining the latest web technologies with flawless aesthetics."
              )}
            </p>
          </motion.div>
